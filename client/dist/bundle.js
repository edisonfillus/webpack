...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _controllers_NegociacaoController_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controllers/NegociacaoController.js */ \"./app-src/controllers/NegociacaoController.js\");\n/* harmony import */ var _domain_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domain/index.js */ \"./app-src/domain/index.js\");\n\n\n\nconst controller = new _controllers_NegociacaoController_js__WEBPACK_IMPORTED_MODULE_0__[\"NegociacaoController\"]();\nconst negociacao = new _domain_index_js__WEBPACK_IMPORTED_MODULE_1__[\"Negociacao\"](new Date(), 1, 200);\nconst headers = new Headers();\nheaders.set('Content-Type', 'application/json');\nconst body = JSON.stringify(negociacao);\nconst method = 'POST';\n\nconst config = {\n    method,\n    headers,\n    body\n};\n\nfetch('/negociacoes', config).then(() => console.log('Dado enviado com sucesso'));\n\n//# sourceURL=webpack:///./app-src/app.js?");
